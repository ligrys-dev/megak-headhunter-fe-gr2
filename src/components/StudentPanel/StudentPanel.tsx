...
export const StudentPanel = () => {
  ...
  const [user, setUser] = useState<StudentProfileInterface | null>({
    ...
    education:
      'Lorem ipsum dolor sit amet, consectetur adipisicing elit. A aliquam atque commodi corporis delectus dolor ducimus earum eos est eum ex facere fuga hic impedit incidunt, inventore',
